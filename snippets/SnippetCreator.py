...
from utils.SnippetUtils import clear_snippets_directories, less_than_interval, analyze_to, SNIPPET_X_AXIS_TEXT
...
def create_snippets_for_company(company: str):
    ...
    gics = get_gics_code_by_company(company[0:len(company) - 4])
